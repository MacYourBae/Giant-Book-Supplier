...
<body class="d-flex flex-column" style="height: 100%" style="width: 100%">
    <main class="">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li>
                                <a class="dropdown-item" href="<?php echo e(route('category.category', $category->id)); ?>"><?php echo e($category->name); ?></a>
                            </li>
        ...
        <h2 class="w-100 text-left" style="background-color: gray"><?php echo $__env->yieldContent('title'); ?></h2>
...
</html><?php /**PATH D:\Data Application\Laravel\EXAM\2440067093_UTS\resources\views/template.blade.php ENDPATH**/ ?>